...
[ExecuteInEditMode]
public class MonoRendererSortingLayerOverride : MonoBehaviour {
...
[CustomEditor(typeof(MonoRendererSortingLayerOverride))]
public class RenderSortingLayerOverrideEditor : Editor {
    
    public override void OnInspectorGUI() {
        var t = (MonoRendererSortingLayerOverride) target;
